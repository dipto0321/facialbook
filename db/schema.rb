...
ActiveRecord::Schema.define(version: 20_190_107_072_427) do
  ...
  create_table 'friend_requests', force: :cascade do |t|
    ...
    t.index %w[requester_id requestee_id], name: 'index_friend_requests_on_requester_id_and_requestee_id', unique: true
